...
public class ValidationItemControllerV2 {
    ...
    /**
     * bindingResult 검증 방법 1
     * - 주의) @ModelAttribute 객체 다음에 BindingResult 객체가 있어야 한다.
     */
    // @PostMapping("/add")
    public String addItemV1(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        if (item.getPrice() != null && item.getQuantity() != null) {
            ...
            if (resultPrice < 10000) {
                bindingResult.addError(new ObjectError("item", "수량은 최대 9,999개 까지 허용합니다."));
            }
        }
...
//    @PostMapping("/add")
    public String addItemV2(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        if (item.getPrice() != null && item.getQuantity() != null) {
            int resultPrice = item.getPrice() * item.getQuantity();
            if (resultPrice < 10000) {
                bindingResult.addError(new ObjectError("item", null, null, "수량은 최대 9,999개 까지 허용합니다."));
            }
        }
...
//    @PostMapping("/add")
    public String addItemV4(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        /*
         * 검증 로직
         * 아래 StringUtils.hasText 와 동일한 기능
         * 그러나 공백 같은 단순한 기능 만 제공 함
         */
